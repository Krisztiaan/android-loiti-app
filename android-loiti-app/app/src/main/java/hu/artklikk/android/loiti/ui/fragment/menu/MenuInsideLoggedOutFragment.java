...
public class MenuInsideLoggedOutFragment extends MenuBaseFragment {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.fragment_menu, container, false);
		root.findViewById(R.id.fragment_menu_main).setOnClickListener(mainClickListener);
		root.findViewById(R.id.fragment_menu_payment).setOnClickListener(registerPopupClickListener);
		root.findViewById(R.id.fragment_menu_qr_reader).setOnClickListener(registerPopupClickListener);
		root.findViewById(R.id.fragment_menu_visitors_book).setOnClickListener(registerPopupClickListener);
		root.findViewById(R.id.fragment_menu_profile).setOnClickListener(registerPopupClickListener);
		root.findViewById(R.id.fragment_menu_gifts).setOnClickListener(registerPopupClickListener);
