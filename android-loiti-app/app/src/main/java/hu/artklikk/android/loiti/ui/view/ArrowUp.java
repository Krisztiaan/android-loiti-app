...
public class ArrowUp extends View {
	...
	public ArrowUp(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	
	public ArrowUp(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (heightDouble == rect.width()) {
			...
			path.moveTo(rect.left, lower);
			path.lineTo(rect.centerX(), upper);
			path.lineTo(rect.right, lower);
		}
		else if (heightDouble < rect.width()) {
			...
			path.moveTo(leftDrawing, rect.bottom);
			path.lineTo(rect.centerX(), rect.top);
			path.lineTo(rightDrawing, rect.bottom);
		}
