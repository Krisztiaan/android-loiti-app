...
public class MenuFarLoggedInFragment extends MenuBaseFragment {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.fragment_menu, container, false);
		root.findViewById(R.id.fragment_menu_main).setOnClickListener(mainClickListener);
		root.findViewById(R.id.fragment_menu_payment).setOnClickListener(insidePopupClickListener);
		root.findViewById(R.id.fragment_menu_qr_reader).setOnClickListener(insidePopupClickListener);
		root.findViewById(R.id.fragment_menu_visitors_book).setOnClickListener(insidePopupClickListener);
		root.findViewById(R.id.fragment_menu_profile).setOnClickListener(profileClickListener);
		root.findViewById(R.id.fragment_menu_gifts).setOnClickListener(insidePopupClickListener);
